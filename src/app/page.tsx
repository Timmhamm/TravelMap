  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-200">
      <div className="absolute top-[10px] left-20 z-[1000] rounded-lg bg-white/95 px-4 py-2 shadow-md">
        ...
        <p className="text-sm text-slate-600">Atlanta · Asia · Japan · Oregon · Portugal · South Dakota · TX/AZ/NV · Australia · Colorado · SoCal · San Francisco · London · Amsterdam · Brussels · Paris · Clearwater · Harpers Ferry · Key West · Washington D.C. · Lake Tahoe · Napa · Philadelphia · Chicago · Pittsburgh · Rehoboth Beach · Reno</p>
      </div>
      <TravelMap />
    </main>
  );
